...
function far_connect_step_list()
{
    ...
    script_js(
        ...
        . 'var $captSel=$("#far_connect_captcha_provider");'
        . 'function farComToggleFrom(val){'
        .   'if(val==="none"){$(".far-com-mail-from").hide();}else{$(".far-com-mail-from").show();}'
        . '}'
        . 'if($mailSel.length){'
        .   'farComToggle("far-com-mail-",["resend","brevo","smtp","none"],$mailSel.val());'
        .   'farComToggleFrom($mailSel.val());'
        .   '$mailSel.change(function(){'
        .     'farComToggle("far-com-mail-",["resend","brevo","smtp","none"],$(this).val());'
        .     'farComToggleFrom($(this).val());'
        .   '});'
        . '}'
        . 'if($captSel.length){'
