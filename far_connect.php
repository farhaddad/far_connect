...
function far_connect_step_list()
{
    ...
    script_js(
        ...
        .   '});'
        . '}'
        . 'function farComToggleCaptcha(){'
        .   'if(captSel){farComToggle("far-com-captcha-",["turnstile","recaptcha","hcaptcha","none"],captSel.value);}'
        . '}'
        . 'if(captSel){'
        .   'farComToggleCaptcha();'
        .   'captSel.addEventListener("change",function(){farComToggle("far-com-captcha-",["turnstile","recaptcha","hcaptcha","none"],this.value);});'
        . '}'
        . 'document.addEventListener("click",function(e){'
        .   'var pane=e.target.closest("[data-txp-pane]");'
        .   'if(pane){setTimeout(farComToggleCaptcha,50);}'
        . '});'
